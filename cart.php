...
if (isset($_POST['update_cart'])) {
  ...
  $cart_quantity = (int)($_POST['cart_quantity'] ?? 1);
  if ($cart_quantity < 1) $cart_quantity = 1;
  if ($cart_quantity > 99) $cart_quantity = 99;
...
if (isset($_POST['delete_cart_id'])) {
  $delete_id = (int)($_POST['delete_cart_id'] ?? 0);
   ...
   <div class="box-container">
      ...
      <div class="box">
         <form method="post" style="display:inline;">
            ...
            <input type="hidden" name="delete_cart_id" value="<?php echo (int)$fetch_cart['id']; ?>">
            <button type="submit" class="fas fa-times" onclick="return confirm('delete this from cart?');" style="border:none;background:none;cursor:pointer;"></button>
         </form>
